...
var G__10074 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10074,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10074;
}
});
...
var len__4730__auto___10079 = arguments.length;
var i__4731__auto___10080 = (0);
while(true){
if((i__4731__auto___10080 < len__4730__auto___10079)){
args__4736__auto__.push((arguments[i__4731__auto___10080]));

var G__10081 = (i__4731__auto___10080 + (1));
i__4731__auto___10080 = G__10081;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10076){
...
var line = cljs.core.get.call(null,map__10083__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10083__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10083,map__10083__$1,file,line,column){
return (function (p1__10082_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10082_SHARP_));
});})(map__10083,map__10083__$1,file,line,column))
...
var temp__5457__auto___10085 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10085)){
var message_10086 = temp__5457__auto___10085;
cljs.core.println.call(null,message_10086);
} else {
}
...
var temp__5457__auto___10087 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10087)){
var message_10088 = temp__5457__auto___10087;
cljs.core.println.call(null,message_10088);
} else {
}
...
var output_dir__$1 = (function (){var G__10089 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__10089,"/"].join('');
} else {
return G__10089;
}
})();
...
var G__10091 = exception.stack;
var G__10091__$1 = (((G__10091 == null))?null:clojure.string.split_lines.call(null,G__10091));
var G__10091__$2 = (((G__10091__$1 == null))?null:cljs.core.get.call(null,G__10091__$1,depth));
if((G__10091__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10091__$2);
}
} else {
...
var vec__10092 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10092,(0),null);
var column = cljs.core.nth.call(null,vec__10092,(1),null);
var vec__10095 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10095,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10095,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10095,(2),null);
...
var m__$1 = (function (){var G__10098 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__10102 = (function (){var G__10101 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10101);
} else {
return G__10101;
}
})();
...
return cljs.core.vary_meta.call(null,G__10103,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e10104){var e = e10104;
var G__10105 = e;
var G__10105__$1 = (((G__10105 instanceof cljs.core.Keyword))?G__10105.fqn:null);
switch (G__10105__$1) {
...
var vec__10107 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10107,(0),null);
var types = vec__10107;
...
return cljs.core.map.call(null,(function (p__10110){
var vec__10111 = p__10110;
var ns = cljs.core.nth.call(null,vec__10111,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10111,(1),null);
return ((function (vec__10111,ns,vars__$1){
return (function (){
...
var G__10114 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__10114,G__10114__$1,env,once_fixtures,each_fixtures,vec__10111,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__10114,G__10114__$1,env,once_fixtures,each_fixtures,vec__10111,ns,vars__$1){
return (function (){
var seq__10115 = cljs.core.seq.call(null,vars__$1);
var chunk__10116 = null;
var count__10117 = (0);
var i__10118 = (0);
while(true){
if((i__10118 < count__10117)){
var v = cljs.core._nth.call(null,chunk__10116,i__10118);
var temp__5457__auto___10120 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10120)){
var t_10121 = temp__5457__auto___10120;
each_fixture_fn.call(null,((function (seq__10115,chunk__10116,count__10117,i__10118,t_10121,temp__5457__auto___10120,v,each_fixture_fn,G__10114,G__10114__$1,env,once_fixtures,each_fixtures,vec__10111,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10121)));
});})(seq__10115,chunk__10116,count__10117,i__10118,t_10121,temp__5457__auto___10120,v,each_fixture_fn,G__10114,G__10114__$1,env,once_fixtures,each_fixtures,vec__10111,ns,vars__$1))
);
} else {
}


var G__10122 = seq__10115;
var G__10123 = chunk__10116;
var G__10124 = count__10117;
var G__10125 = (i__10118 + (1));
seq__10115 = G__10122;
chunk__10116 = G__10123;
count__10117 = G__10124;
i__10118 = G__10125;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__10115);
if(temp__5457__auto__){
var seq__10115__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10115__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__10115__$1);
var G__10126 = cljs.core.chunk_rest.call(null,seq__10115__$1);
var G__10127 = c__4550__auto__;
var G__10128 = cljs.core.count.call(null,c__4550__auto__);
var G__10129 = (0);
seq__10115 = G__10126;
chunk__10116 = G__10127;
count__10117 = G__10128;
i__10118 = G__10129;
continue;
} else {
var v = cljs.core.first.call(null,seq__10115__$1);
var temp__5457__auto___10130__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10130__$1)){
var t_10131 = temp__5457__auto___10130__$1;
each_fixture_fn.call(null,((function (seq__10115,chunk__10116,count__10117,i__10118,t_10131,temp__5457__auto___10130__$1,v,seq__10115__$1,temp__5457__auto__,each_fixture_fn,G__10114,G__10114__$1,env,once_fixtures,each_fixtures,vec__10111,ns,vars__$1){
return (function (){
...
});})(seq__10115,chunk__10116,count__10117,i__10118,t_10131,temp__5457__auto___10130__$1,v,seq__10115__$1,temp__5457__auto__,each_fixture_fn,G__10114,G__10114__$1,env,once_fixtures,each_fixtures,vec__10111,ns,vars__$1))
);
} else {
}


var G__10132 = cljs.core.next.call(null,seq__10115__$1);
var G__10133 = null;
var G__10134 = (0);
var G__10135 = (0);
seq__10115 = G__10132;
chunk__10116 = G__10133;
count__10117 = G__10134;
i__10118 = G__10135;
continue;
}
} else {
...
});})(each_fixture_fn,G__10114,G__10114__$1,env,once_fixtures,each_fixtures,vec__10111,ns,vars__$1))
);
});})(each_fixture_fn,G__10114,G__10114__$1,env,once_fixtures,each_fixtures,vec__10111,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10114__$1)].join('')));

}
})());
});
;})(vec__10111,ns,vars__$1))
