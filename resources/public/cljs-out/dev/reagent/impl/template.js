...
var G__10566 = o;
(G__10566[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10568__i < G__10568__a.length) {G__10568__a[G__10568__i] = arguments[G__10568__i + 0]; ++G__10568__i;}
  args = new cljs.core.IndexedSeq(G__10568__a,0,null);
} 
...
var G__10570 = o;
(G__10570[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__10571__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
return G__10571__delegate.call(this,args);};
...
return G__10571__delegate(args);
});
...
var G__10575 = props;
var G__10575__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__10575,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10575);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__10575__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__10576){
var map__10577 = p__10576;
var map__10577__$1 = (((((!((map__10577 == null))))?(((((map__10577.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10577.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10577):map__10577);
var props = map__10577__$1;
var class$ = cljs.core.get.call(null,map__10577__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__10577,map__10577__$1,props,class$){
return (function (c){
...
});})(map__10577,map__10577__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10579){
...
var on_write = cljs.core.get.call(null,map__10580__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__10580,map__10580__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__10580,map__10580__$1,on_write))
);
} else {
...
var G__10583 = jsprops;
(G__10583["defaultValue"] = value);

(G__10583["onChange"] = ((function (G__10583,v,value,on_change){
return (function (p1__10582_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10582_SHARP_);
});})(G__10583,v,value,on_change))
);
...
var vec__10586 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10586,(0),null);
var id = cljs.core.nth.call(null,vec__10586,(1),null);
var class$ = cljs.core.nth.call(null,vec__10586,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___10590 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___10590 == null)){
} else {
var key_10591 = temp__5461__auto___10590;
(jsprops["key"] = key_10591);
}
...
var temp__5461__auto___10592 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___10592 == null)){
} else {
var key_10593 = temp__5461__auto___10592;
reagent.impl.template.oset.call(null,jsprops,"key",key_10593);
}
...
var G__10594 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__10594["name"] = c);
...
args__4736__auto__.push((arguments[i__4731__auto___10601]));
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10598){
var G__10599 = cljs.core.first.call(null,seq10598);
var seq10598__$1 = cljs.core.next.call(null,seq10598);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10599,seq10598__$1);
});
...
break;
default:
var G__10605 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__10605;
continue;
...
var n__4607__auto___10607 = a.length;
var i_10608 = (0);
while(true){
if((i_10608 < n__4607__auto___10607)){
(a[i_10608] = reagent.impl.template.as_element.call(null,(a[i_10608])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___10610 = a.length;
var i_10611 = (0);
while(true){
if((i_10611 < n__4607__auto___10610)){
var val_10612 = (a[i_10611]);
if(((cljs.core.vector_QMARK_.call(null,val_10612)) && ((reagent.impl.template.key_from_vec.call(null,val_10612) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10611] = reagent.impl.template.as_element.call(null,val_10612));

var G__10613 = (i_10611 + (1));
i_10611 = G__10613;
continue;
} else {
}
...
var ctx = ({});
var vec__10614 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__10614,(0),null);
var derefed = cljs.core.nth.call(null,vec__10614,(1),null);
...
var G__10617 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10617) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__10617){
