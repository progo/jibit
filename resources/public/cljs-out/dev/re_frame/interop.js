...
return [(function (){var pred__19784 = cljs.core.instance_QMARK_;
var expr__19785 = reactive_val;
if(cljs.core.truth_(pred__19784.call(null,reagent.ratom.RAtom,expr__19785))){
return "ra";
} else {
if(cljs.core.truth_(pred__19784.call(null,reagent.ratom.RCursor,expr__19785))){
return "rc";
} else {
if(cljs.core.truth_(pred__19784.call(null,reagent.ratom.Reaction,expr__19785))){
return "rx";
} else {
if(cljs.core.truth_(pred__19784.call(null,reagent.ratom.Track,expr__19785))){
return "tr";
} else {
return "other";
}
