...
* TODO =photo.is_raw= should be a boolean 1/0, not a string   :inbox:backend:
...
** TODO Don't send gear data in get-photos?
...
* TODO Human shutter speed of "1 sec" shows wrong
