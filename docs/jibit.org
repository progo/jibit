...
* TODO Normalize lens/camera info?
...
Some material in human.clj ready to be made into tests.
* TODO Check out if Metosin muuntaja is useful
* TODO Unify terms in code backend/frontend

- Negatives, photos, images... Just *photo* is good? 
- What we call the view in jibit?
