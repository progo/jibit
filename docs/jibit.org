...
* TODO After import, clean empty and "empty" directories from inbox :inbox:backend:
...
* TODO Move http server parts of =clurator.core= elsewhere
* TODO Work on Import [1/7]                                          :import:
SCHEDULED: <2020-05-17 Sun>

- [X] CLI interaction/launcher to start import
- [ ] Speedy shutdown after CLI invocation has processed everything
- [ ] Clean the empty dirs on inbox after import
- [ ] Notify / mark DB during import
  Then UI can be notified.
- [ ] Import logs
...
* TODO Date filters aren't working
