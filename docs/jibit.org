...
- [ ] Deleting a tag, enforce tagged items (set null but ask)
- [ ] Deleting a tag, enforce parent relation (set null but ask)
- [ ] Confirm deleting a tag beforehands
...
** TODO UI enhancements on Tag Color selection

- [ ] If user deselects "Use color" checkbox, clear the color from
  colorselector
- [ ] If user selects a color using the selector, select "Use color"
  automatically
...
* DONE Tag things pt 2 [3/3]
CLOSED: [2020-04-14 Tue 18:16]
:LOGBOOK:
- State "DONE"       from "TODO"       [2020-04-14 Tue 18:16]
:END:
