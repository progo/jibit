...
** TODO Make user_label used everywhere
** TODO One might still question whether separate tables for Camera, Lens make sense

Let's do this.

** TODO Bypassing the sub model in =(flatten-gear-list)= is a terrible offense
...
* TODO "keywordify" is twice implemented

Once in =exif.clj= and more recently in CLJS(?)
